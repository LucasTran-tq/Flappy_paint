...
namespace WindowsFormsApplication1
{
    class LifeSpan
    {
        ...
        public Bitmap shield_Bitmap = new Bitmap(Properties.Resources.superman);
        ...
        {
            X_Shield = bird.X_Bird + bird.recBird.Width + 10;
            ...
            if (Shield_IsExist())
            {
                ...
                if ((X_Shield + recShield.Width >= rocket.X_Rocket) && (X_Shield <= rocket.X_Rocket + rocket.recRocket.Width))
                {
                    ...
                    if (Y_Shield + recShield.Height >= rocket.Y_Rocket && bird.Y_Bird <= rocket.Y_Rocket + rocket.recRocket.Height)
                    {
                        ...
                        {
                            iHearts--;
                            //rocket.rocket_Apearance = false;

                            rocket.fire_Appearance = true;
